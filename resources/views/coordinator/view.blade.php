...
<h2 style="color:#fff; font-weight:bolder;">Personal Data Sheet</h2>
    ...
    <a href="/coordinator/scholarshipdetailscoordinator/{{ $details->student_id }}"><button type="button" class="greenbutton" style="  margin-top:-4vw; margin-right:-0vw;margin-left:5vw">SCHOLARSHIP</button></a>
