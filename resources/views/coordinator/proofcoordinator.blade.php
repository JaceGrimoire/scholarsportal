...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- SCRIPT -->
        <script src="/css/Coordinator.js"></script>
...
<div class="w3-card-4" style="width: 70vw; margin-left:25vw; height:20vw;">
  ...
  <li style="margin-top:-2vw; margin-left: 2vw; font-size:1.5vw; font-weight:bolder;"><a href="/files/{{$proofs->name}}">{{$proofs->inclusive_year}}</a></li><br><br>
    @endforeach
</ul>
