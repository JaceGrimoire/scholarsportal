...
<div class="w3-container" style="background-color:#E5E4E2; color:#808080; width: 1600vw; ">
        ...
        <p style="float:left; font-size:2vw; font-weight:bolder; color:#000;">{{Auth::guard('coordinator')->user()->college}} (List of Applicants)</p>
        </div>
...
<table id="myTable">
        ...
        <td><a href="/coordinator/view/{{$scholar->student_id}}">
