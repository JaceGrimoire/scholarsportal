...
<input type="button" class="downloadbutton" value="DOWNLOAD" style="width:10vw; height:2.5vw; margin-left:45vw; margin-bottom:5vw;"  
id="btPrint" onclick="createPDF()" />

<a href="/coordinator/dashboard"><button type="button" class="greenbutton" style="  margin-top:-7.5vw; margin-right:1vw;margin-left:5vw">CANCEL</button></a>
