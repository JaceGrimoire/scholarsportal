...
<div class="w3-container" style="background-color:#E5E4E2; color:#808080; width: 1600vw; ">
        <p style="float:left; font-size:2vw; font-weight:bolder; color:#000;">{{Auth::guard('coordinator')->user()->college}} (List of Scholars)<br></p>
  ...
  <div class="search-container" style="float:right; margin-top:-3vw;">
    ...
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search.."  title="Type in a name"><i class="fa fa-search"></i>
...
<table id="myTable">
        ...
        <td><a href="/coordinator/scholarsview/{{$scholar->student_id}}">
        <button type="button" class="downloadbutton" style="width:5vw;">VIEW</button></a></td>
        <form action="/coordinator/listcoordinator/{{ $scholar->student_id }}" method="POST">
        @csrf
