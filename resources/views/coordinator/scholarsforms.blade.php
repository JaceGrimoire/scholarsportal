...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <a href="/coordinator/calendaradmin" class="w3-bar-item w3-button" style="font-size:1.4vw;"><i class="glyphicon glyphicon-calendar" style="font-size:2vw; left:-0.5vw;color:black;"></i>Calendar of Events</a><br>
