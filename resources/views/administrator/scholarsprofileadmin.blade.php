...
<h2 style="color:#fff; font-weight:bolder;">Personal Data Sheet</h2>
  ...
  <div id="tab">
    ...
    <a href="/administrator/scholarshipdetailsadmin/{{ $details->student_id }}"><button type="button" class="greenbutton" style="  margin-top:-4vw; margin-right:-0vw;margin-left:5vw">SCHOLARSHIP</button></a>
    <a href="/administrator/formsadmin/{{ $details->student_id }}"><button type="button" class="greenbutton" style="  margin-top:-4vw; margin-right:10vw;margin-left:5vw">FORMS</button></a>
    <label class="w3-text-black">First Name</label>
    <input class="w3-input w3-border w3-sand" style="width:62vw;" name="first" type="text" placeholder="{{ $details->first_name }}"></p>
   
    <p>      
    <label class="w3-text-black">Middle Name</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->middle_name }}" readonly></p>

    <p>      
    <label class="w3-text-black">Last Name</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->last_name }}" readonly></p>

    <p>      
    <label class="w3-text-black">Suffix</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->suffix }}" readonly></p><br>


    <p>      
    <label class="w3-text-black">Student Number</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->student_id }}" readonly></p>
    
    <p>      
    <label class="w3-text-black">Mobile Number</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->mobile_num }}" readonly></p>
    ...
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->house_num }}" readonly></p>

    <p>      
    <label class="w3-text-black">Street</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->street }}" readonly></p>

    <p>      
    <label class="w3-text-black">Brgy.</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->barangay }}"readonly></p>

    <p>      
    <label class="w3-text-black">City/Municipality</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->city }}" readonly></p>

    <p>      
    <label class="w3-text-black">Province</label>
    <input class="w3-input w3-border w3-sand" name="last" type="text" placeholder="{{ $details->province }}" readonly></p><br><br>
...
id="btPrint" onclick="createPDF()" />
        ...
        <a href="{{URL::previous()}}"><button type="button" class="greenbutton" style="  margin-top:-0vw; margin-right:18vw;margin-left:5vw">CANCEL</button></a>
